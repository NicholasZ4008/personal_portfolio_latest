...
export const BentoGridItem = ({
  ...
  const rightLists = ["Angular", "PostgreSQL", "Coolify"];

  const [copied, setCopied] = useState(false);

  // Create a client-side only component for Lottie
  ...
  const handleCopy = () => {
    const text = "nicholas.zhang4008@gmail.com";
        ...
        >
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              >
                {typeof window !== "undefined" && copied && <LottieComponent />}
              </div>
